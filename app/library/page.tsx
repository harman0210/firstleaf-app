  ...
  return (
    <div className="relative min-h-screen bg-gray-50 overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div className="absolute -top-32 left-0 w-[140%] h-[140%] animate-pulse-slow rounded-full bg-gradient-to-r from-emerald-100 via-white to-emerald-50 opacity-40 blur-3xl"></div>
      </div>
